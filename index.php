<?php include 'assets/scripts/navbar.php';?>
    <div class="">
      <section id="home" class="mt-2 h-[60dvh] bg-slate-900 p-3 rounded-lg border border-slate-800">
        <div class="bg-cover bg-center bg-no-repeat bg-[url('assets/img/home-cover.jpeg')] h-full rounded-lg flex flex-col items-center justify-center text-shadow-lg text-shadow-black">
